...
store.dispatch(actions.enterFloor(1, 'a_abramov'))
store.dispatch(actions.enterFloor(2, 'n_nikolaev'))
store.dispatch(actions.enterFloor(2, 's_smirnov'))
store.dispatch(actions.enterFloor(3, 'i_ivanov'))
store.dispatch(actions.enterFloor(2, 'p_potapov'))
store.dispatch(actions.enterFloor(4, 'k_kirilenko'))
store.dispatch(actions.enterFloor(2, 'b_borisov'))
